<template>
    ...
    <AboutSection class="bg-base-200" v-bind="aboutSectionData.hosting" />
    <AboutSection class="bg-base-100" v-bind="aboutSectionData.webDev" />
    <AboutSection class="bg-base-200" v-bind="aboutSectionData.other" />
</template>
